...
submit2Button.onclick = function () {
    ...
    if (!oddNumberInput.value) {
        ...
        const story2 = "The keyboard has" + oddNumberInput.value + " odd numbers." + shoeSizeInput.value + " has no value to your life & playing " + favouriteSportInput.value + " online isn't real sports. none the less, your NOT good at it so STOP!!! Turn the console off, go sit in a corner & eat some " + iceCreamInput;

        story2P.textContent = story
...
submit3Button.onclick = function () {
    ...
    if (!ingredientOneInput.value) {
        ...
        const story3 = "One fly fue mdnsadlas danss " +
